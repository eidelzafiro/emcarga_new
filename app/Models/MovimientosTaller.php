...
class MovimientosTaller extends Model {
    ...
    protected function casts(): array { return ['fecha_inicio' => 'datetime', 'fecha_final' => 'datetime']; }
    public function nave(): BelongsTo { return $this->belongsTo(Nave::class, 'id_nave'); }
    public function valla(): BelongsTo { return $this->belongsTo(Valla::class, 'id_valla'); }
}
