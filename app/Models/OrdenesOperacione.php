...
class OrdenesOperacione extends Model {
    ...
    public function orden() { return $this->belongsTo(OrdenesTaller::class, 'id_orden_taller'); }
    public function tipoOperacion() { return $this->belongsTo(TiposOperacione::class, 'id_tipo_operacion'); }
}
