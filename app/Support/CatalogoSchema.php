...
class CatalogoSchema
{
    ...
    private const DEFAULT_FIELDS = [
        ...
        'colores' => [],
        'grupos' => [],
        'categorias_cargo' => ['abreviatura' => ['label' => 'Abreviatura', 'type' => 'text']],
        'clasificaciones_ordenes_taller' => [],
        'destinos_agregados' => [],
        'posiciones_neumaticos' => ['descripcion' => ['label' => 'Descripción', 'type' => 'textarea']],
        'medidas_neumaticos' => ['medida' => ['label' => 'Medida', 'type' => 'text']],
