...
class CatalogoSchema
{
    ...
    private const EXTRA_FIELDS = [
        ...
        'tipos_sistemas_pago' => [],
        'cargos' => [
            'funciones' => ['label' => 'Funciones', 'type' => 'textarea'],
            'medios_requeridos' => ['label' => 'Medios Requeridos', 'type' => 'textarea'],
            'competencias' => ['label' => 'Competencias', 'type' => 'textarea'],
            'es_chofer' => ['label' => 'Es Chofer', 'type' => 'boolean'],
        ],
        'tipos_aceites' => [],
        'tipos_agregados' => [],
        'tipos_cargas' => [],
        ...
        'tipos_incidencias' => [
            ...
            'penalizacuc' => ['label' => 'Penaliza CUC', 'type' => 'boolean'],
        ],
        'tipos_neumaticos' => [],
        'tipos_documentos' => [],
        'tipos_estado_civil' => [],
