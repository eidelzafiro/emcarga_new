  ...
  <div class="min-h-screen flex">
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-950 via-blue-900 to-gray-900 relative overflow-hidden">
      ...
      <div class="relative z-10 flex flex-col justify-between p-12 w-full">
        ...
        <div>
          <h1 class="text-4xl font-bold text-white leading-tight">Nueva contraseña</h1>
          <p class="text-blue-200/80 mt-4 text-lg max-w-md">Defina una contraseña segura para volver a acceder al sistema.</p>
        </div>
    ...
    <div class="flex-1 flex items-center justify-center px-6 py-12 bg-white">
      <div class="w-full max-w-sm">
        ...
        <div class="text-center lg:text-left mb-8">
          ...
          <p v-if="email" class="text-gray-500 mt-1">Para el correo: {{ email }}</p>
        </div>
