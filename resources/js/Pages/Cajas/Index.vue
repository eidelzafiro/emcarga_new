...
const props = defineProps({ title: String, cajas: Object, filters: Object })
...
function destroy(item) {
  if (!confirm(`¿Eliminar la caja ${item.codigo ?? item.id}?`)) return
  router.delete(route('cajas.destroy', { caja: item.id }))
}
</script>
